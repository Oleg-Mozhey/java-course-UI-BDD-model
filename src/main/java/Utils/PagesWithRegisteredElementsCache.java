 ...
 */
public final class PagesWithRegisteredElementsCache {
    ...
    public PagesWithRegisteredElementsCache() {
    ...
    private Class<? extends WebPage> getPageFromPagesByName(String pageName) throws IllegalArgumentException {
        ...
        if (page == null) {
            throw new IllegalArgumentException("Pag with name" + pageName + "' doesn't found");
        }
        return page;
    }
